...
var OdooJsonRpcConnection = /** @class */ (function () {
    function OdooJsonRpcConnection() {
    }
    OdooJsonRpcConnection.handleRequest = function (props, page, domain, limit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, axios_1.default.post("/web/dataset/call_kw", {
                        jsonrpc: "2.0",
                        method: "call",
                        params: {
                            model: props.model,
